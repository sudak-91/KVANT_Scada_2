...
namespace KVANT_Scada_2.OPCUAWorker
{
    ...
    public class OPCUAWorker
    {
        ...
        ApplicationInstance application;//Конфигурация приложения
        ...
        public void StartOPCUAClient()
        {
            ...
            lock (OPCObjects.OPCLocker)
            {
                ...
                ValveStatus.ReadValue(ref session, ref OPCObjects.BAV_3_status);
                ValveStatus.ReadValue(ref session, ref OPCObjects.FVV_S_Status);
                ValveStatus.ReadValue(ref session, ref OPCObjects.FVV_B_Status);
                ValveStatus.ReadValue(ref session, ref OPCObjects.CPV_Status);
                ValveStatus.ReadValue(ref session, ref OPCObjects.SHV_Status);
                ...
                #region Crio_pump
                CrioStatus.ReadStatus(ref session, ref OPCObjects.CrioStatus);
                #endregion




                OpenCam.ReadValue(ref session, ref OPCObjects.openCam);

                CrioPumpStart.ReadValue(ref session, ref OPCObjects.CrioPumpStart);
                CamPrepare.ReadValue(ref session, ref OPCObjects.camPrepare);
                IonStatus.ReadValue(ref session, ref OPCObjects.IonStatus);
                IonOutputFeedBack.ReadValue(ref session, ref OPCObjects.IonOutputFeedBack);
                IonInputSetPoint.ReadValue(ref session, ref OPCObjects.IonInputSetPoint);
                ...
                FVPStatus.ReadValue(ref session, ref OPCObjects.FVPStatus);
            ...
            timer = new Timer(OpcInnerTimer, session, 0, 2000);
